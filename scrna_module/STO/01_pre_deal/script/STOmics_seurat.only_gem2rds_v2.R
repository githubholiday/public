...
#
########
#.libPaths(c('/annoroad/data1/software/install/Miniconda/Miniconda3-4.10.3-py3.9.5/envs/leiguo_R/lib/R/library', .libPaths()))
...
para<-matrix(c(
        ...
        'tissue',   't',   2,      "character",
        'outdir','o',1,"character"
),byrow=TRUE,ncol=4)
opts <- getopt(para,debug=FALSE)
...
#parser$add_argument('-b', '--binsize', dest = 'binsize', default = 200, type = 'integer', help = 'bin size to binning, your input should be in binSize1 if you set this')
...
saveRDS(seurat_spatialObj, file = paste0(opts$outdir, '/', opts$sample, '_seurat.rds'))
